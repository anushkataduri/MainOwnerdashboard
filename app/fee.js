...
const FeeManagement = () => {
 const {
  ...
  {p.date} {" • "} {p.time}
  {p.status === "pending" ? " • " + getRelativeDueDate(p) : ""}
</Text>
                  </View>
  ...
  {selectedPayment?.tenant} {" • "} ₹{selectedPayment?.amount}
            ...
            <View style={styles.sheetBody}>
              ...
              >
                <View style={[styles.sheetIconBox, { backgroundColor: `${COLORS.SUCCESS}15` }]}>
              ...
              >
                <View style={[styles.sheetIconBox, { backgroundColor: `${COLORS.WARNING}15` }]}>
              ...
              >
                <View style={[styles.sheetIconBox, { backgroundColor: `${COLORS.INFO}15` }]}>
                  <Icon name="phone" size={20} color={COLORS.INFO} />
                </View>
                <Text style={styles.sheetItemText}>Call {selectedPayment?.tenant}</Text>
              </TouchableOpacity>
              ...
              >
                <View style={[styles.sheetIconBox, { backgroundColor: `${COLORS.ERROR}15` }]}>
          ...
          <View style={styles.transcriptCard}>
            <View style={styles.transcriptHeader}>
              <View>
                ...
                <Text style={styles.transcriptSubtitle}>Transaction ID: {selectedPayment?.id}</Text>
              </View>
              <View style={[styles.statusBadge, { backgroundColor: selectedPayment?.status === 'collected' ? '#E8F5E9' : '#FFF3E0' }]}>
                <Text style={[styles.statusBadgeText, { color: selectedPayment?.status === 'collected' ? COLORS.SUCCESS : COLORS.WARNING }]}>
            ...
            <View style={styles.transcriptBody}>
              <View style={styles.transcriptInfoRow}>
                ...
                <Text style={styles.transcriptValue}>{selectedPayment?.tenant}</Text>
              </View>
              <View style={styles.transcriptInfoRow}>
                <Text style={styles.transcriptLabel}>Phone Number</Text>
                <Text style={styles.transcriptValue}>{selectedPayment?.phone || "N/A"}</Text>
              </View>
              <View style={styles.transcriptInfoRow}>
                <Text style={styles.transcriptLabel}>Payment Month</Text>
                <Text style={styles.transcriptValue}>{selectedPayment?.month}</Text>
              </View>
              <View style={styles.transcriptInfoRow}>
...
<Text style={styles.transcriptValue}>
  {selectedPayment?.date} {" at "} {selectedPayment?.time}
              ...
              <View style={styles.transcriptTotalRow}>
                ...
                <Text style={styles.transcriptTotalValue}>₹{selectedPayment?.amount}</Text>
              </View>
            </View>
